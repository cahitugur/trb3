void first()
{
   ...
   for (int cnt=0;cnt<4;cnt++) {
      ...
      tdc->SetRefChannel(0, 0, 0x10, 6000, -3.,  3., true);
      tdc->SetRefChannel(1, 1, 0x10, 6000, -3.,  3., true);
      tdc->SetRefChannel(7, 1, 0x10, 6000, -3.,  3., true);
      
      
      //tdc->SetRefChannel(1, 3, 0xffff, 20000, -10., 10., true);
      ...
      tdc->LoadCalibration(Form("calibrations/fpga1-3_%04x.cal", tdcmap[cnt]));
