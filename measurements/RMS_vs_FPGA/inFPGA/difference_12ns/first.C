void first()
{
   ...
   for (int cnt=0;cnt<4;cnt++) {
      ...
      tdc->SetRefChannel(7, 1, 0xffff, 4000, 10.,  14., true);
      ...
      tdc->LoadCalibration(Form("calibrations/fpga4_%04x.cal", tdcmap[cnt]));

      // calculate and write static calibration at the end of the run
      //tdc->SetWriteCalibration(Form("calibrations/fpga4_%04x.cal", tdcmap[cnt]));
